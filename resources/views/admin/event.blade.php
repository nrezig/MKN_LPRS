...
<head>
    ...
    <link rel="stylesheet" href="/MKN_LPRS/resources/css/animations.css">
    <link rel="stylesheet" href="/MKN_LPRS/resources/css/main.css">
    <link rel="stylesheet" href="/MKN_LPRS/resources/css/admin.css">
        ...
        <table class="menu-container" border="0">
            ...
            <tr class="menu-row" >
                <td class="menu-btn menu-icon-dashbord menu-active menu-icon-dashbord-active" >
                    <a href="{{route("admin.index")}}" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Dashboard</p></a>
    </div>
    </a>
    </td>
    </tr>
